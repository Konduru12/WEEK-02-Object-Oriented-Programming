...
public class EcommerencePlatform {
    public static void main(String[] args) {
        Customer1 customer1=new Customer1("Abhinaya");
        Customer1 customer2=new Customer1("Sasanka");

        Product product1=new Product("Ice cream");
        Product product2=new Product("Chocolate");

        Order order1=new Order("A23");
        Order order2=new Order("AB3");
