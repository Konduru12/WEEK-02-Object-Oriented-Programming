...
public class SchoolCourses{
    public static void main(String[] args) {
        School school = new School("Minerva");
        Course math = new Course("Mathematics");
        Course science = new Course("Science");
        Course Biology = new Course("Biology");
        Student student1 = new Student("Abhinaya", "Female");
        Student student2 = new Student("Bharath", "Male");
        Student student3 = new Student("Chintu", "Male");
