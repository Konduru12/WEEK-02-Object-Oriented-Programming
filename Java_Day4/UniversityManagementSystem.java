...
public class UniversityManagementSystem {
    public static void main(String[] args) {
        Student1 student1=new Student1("Abhinaya");
        Student1 student2=new Student1("Susmitha");

        Professor professor1=new Professor("Angeline");
        Professor professor2=new Professor("Rama");

        Course1 course1=new Course1("Python");
