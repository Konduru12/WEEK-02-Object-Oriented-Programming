...
public class HospitalManagement {
    public static void main(String[] args) {
        ...
        Hospital.Doctor doctor1 = hospital1.new Doctor("Dr. Rama");
        Hospital.Doctor doctor2 = hospital1.new Doctor("Dr. Lakshman");

        Hospital.Patient patient1 = hospital1.new Patient("Seetha");
        Hospital.Patient patient2 =hospital1.new Patient("Urmila");
